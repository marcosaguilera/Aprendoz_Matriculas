...
public class source extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    ...
    String idsy=String.valueOf(parameters.get("paramSy"));
    System.out.println("nombre archivo: "+fileName);
    System.out.println("tipo documento: "+typeDocument);
    System.out.println("idsy: "+idsy);
    System.out.println("Parametros: "+parameters);
    URL fileUrl = this.getClass().getResource(fileName);
    System.out.println("RutaURL::: "+fileUrl);
    
    int idsy1= Integer.valueOf(idsy);
    
    parameters.put("sy",idsy1);
    System.out.println("Param::: "+idsy1);
