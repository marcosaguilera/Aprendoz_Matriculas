...
public class Mensualidad extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
   public DownloadResponse getReport(String pr_persona) throws Exception {
      ...
      //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("reciboMensualidades.jasper");
      ...
      //cargar pdf como una respuesta de descarga
          ret.setContentType(mimeFileTypeMap.getContentType("reciboMensualidades.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("presupuestoMensualidades_"+idestd+".pdf");
