...
public class pagare extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
   public DownloadResponse getReport(String pr_persona) throws Exception {
      ...
      //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("pagare.jasper");
      ...
      //cargar pdf como una respuesta de descarga
          ret.setContentType(mimeFileTypeMap.getContentType("pagare.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Pagare_"+idestd+".pdf");
